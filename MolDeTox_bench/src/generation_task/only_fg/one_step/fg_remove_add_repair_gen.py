"""Generate fg_remove_add_repair_multi QA set (only_fg / one_step)"""
...
def generate_fg_remove_add_repair_multi_qa(
    ...
    """Generate fg_remove_add_repair_multi QA items from only_fg_one_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"fg_remove_add_repair_multi_one_step_{idx}"
