"""Generate toxicity_repair_generation_multi QA set (only_fg / one_step)"""
...
def generate_toxicity_repair_generation_multi_qa(
    ...
    """Generate toxicity_repair_generation_multi QA items from only_fg_one_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"toxicity_repair_generation_multi_one_step_{idx}"
