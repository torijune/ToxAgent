"""Generate fg_remove_add_repair_multi QA set (only_fg / multi_step)"""
...
def generate_fg_remove_add_repair_multi_qa(
    csv_path: str,
    output_path: Optional[str] = None,
    smiles_format: str = "smiles",
    limit: Optional[int] = None
) -> List[Dict[str, Any]]:
    """Generate fg_remove_add_repair_multi QA items from only_fg_multi_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            question = template.create_question(
                ...
                question_type="fg_remove_add_repair_multi",
            ...
            qa_id = f"fg_remove_add_repair_multi_multi_step_{idx}"
            context = create_base_context(row, "fg_remove_add_repair_multi", tx_smiles, nt_smiles)
...
if __name__ == "__main__":
    ...
    qa_items = generate_fg_remove_add_repair_multi_qa(
