"""Generate stereo_repair_gen QA set (only_stereo / multi_step)"""
...
def generate_stereo_repair_gen_qa(
    ...
    """Generate stereo_repair_gen QA items from only_stereo_multi_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"stereo_repair_gen_multi_step_{idx}"
