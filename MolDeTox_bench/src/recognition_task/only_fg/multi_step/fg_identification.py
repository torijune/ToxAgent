"""Generate fg_identification QA set (only_fg / multi_step)"""
...
def generate_fg_identification_qa(
    ...
    """Generate fg_identification QA items from only_fg_multi_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"fg_identification_multi_step_{idx}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv-path", type=str, required=True,
                        help="Path to check_diff directory or only_fg_multi_step_diff.csv")
