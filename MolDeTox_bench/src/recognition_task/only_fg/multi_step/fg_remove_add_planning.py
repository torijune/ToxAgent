"""Generate fg_repair_planning QA set (only_fg / multi_step)"""
...
def generate_fg_repair_planning_qa(
    ...
    """Generate fg_repair_planning QA items from only_fg_multi_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"fg_repair_planning_multi_step_{idx}"
