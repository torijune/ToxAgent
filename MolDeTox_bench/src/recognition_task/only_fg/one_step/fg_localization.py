"""Generate toxic_site_localization QA set (only_fg / one_step)"""
...
def generate_toxic_site_localization_qa(
    ...
    """Generate toxic_site_localization QA items from only_fg_one_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"toxic_site_localization_one_step_{idx}"
