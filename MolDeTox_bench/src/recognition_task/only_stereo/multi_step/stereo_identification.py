"""Generate stereo_identification QA set (only_stereo / multi_step)"""
...
def generate_stereo_identification_qa(
    ...
    """Generate stereo_identification QA items from only_stereo_multi_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"stereo_identification_multi_step_{idx}"
