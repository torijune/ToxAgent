"""Generate stereo_repair_planning QA set (only_stereo / one_step)"""
...
def generate_stereo_repair_planning_qa(
    ...
    """Generate stereo_repair_planning QA items from only_stereo_one_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            qa_id = f"stereo_repair_planning_one_step_{idx}"
