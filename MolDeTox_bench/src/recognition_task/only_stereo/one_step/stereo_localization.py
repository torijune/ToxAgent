"""Generate stereo_toxic_site_localization QA set (only_stereo / one_step)"""
...
def _build_stereo_from_columns(row, prefix='toxic') -> dict:
    """Build stereochemistry dict. Converts bond lists to tuples (avoids unhashable key error)."""
...
def generate_stereo_localization_qa(
    ...
    """Generate stereo_toxic_site_localization QA items from only_stereo_one_step_diff.csv."""
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            # Try pre-stored stereochemistry, fall back to building from individual columns
            ...
            qa_id = f"stereo_toxic_site_localization_one_step_{idx}"
