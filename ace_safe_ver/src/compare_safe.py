...
molecule_safe_ver/src/compare_safe.py 와 동일 로직.
"""
import json
...
PAIRS_SAFE_CSV = ACE_SAFE_VER_DIR / "pairs_safe.csv"
OUTPUT_CSV = ACE_SAFE_VER_DIR / "pairs_safe_compared.csv"
...
def build_unique_safe_json(only_toxic, only_nontoxic):
    """unique한 fragment 목록을 reason과 함께 JSON 리스트로."""
    out = []
