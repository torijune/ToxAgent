...
# ace_safe_ver 번들: 루트 = 이 파일의 상위(ace_safe_ver/src -> ace_safe_ver)
_ACE_SRC = Path(__file__).resolve().parent
ACE_SAFE_VER_ROOT = _ACE_SRC.parent
BASE = ACE_SAFE_VER_ROOT
SCAFFOLD_SIM_DIR = BASE / "scaffold_sim"
SUMMARY_CSV = SCAFFOLD_SIM_DIR / "summary.csv"
OUT_DIR = BASE / "data" / "molecular_ace_pairing_batch"
